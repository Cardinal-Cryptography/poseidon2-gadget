...
use halo2_proofs::{
    ...
    plonk::{
        Advice, Column, ConstraintSystem, Constraints, ErrorFront, Expression, Fixed, Selector,
    },
    poly::Rotation,
};
    ...
    fn add_input(
        ...
        layouter.assign_region(
            ...
            |mut region| {
                ...
                let output: Result<Vec<_>, ErrorFront> =
                    (0..WIDTH).map(constrain_output_word).collect();
